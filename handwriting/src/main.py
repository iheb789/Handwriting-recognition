...
class FilePaths:
    ...
    fn_char_list = 'C:/handwriting/model/charlist.txt'
    fn_summary = 'C:/handwriting/model/summary.json'
    fn_corpus = 'C:/handwriting/data/corpus.txt'
...
def infer(model: Model, fn_img: Path) -> None:
    ...
    # Ensure that fn_img is a string (file path)
